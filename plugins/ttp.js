...
Asena.addCommand({ pattern: 'ttp ?(.*)', fromMe: true, desc: Lang.TTP_DESC }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'Made by Avara BOT' })
...
Asena.addCommand({ pattern: 'colorttp ?(.*)', fromMe: true, desc: cof }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.video, { mimetype: Mimetype.mp4, caption: 'Made by Avara BOT' })
...
Asena.addCommand({ pattern: 'glowttp ?(.*)', fromMe: true, desc: GW }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'Made for Avara BOT' })
